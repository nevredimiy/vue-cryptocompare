  ...
  <div class="container">
    ...
    <template v-if="tickers.length">
      ...
      <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
        ...
        v-for="t in tickers"
        :key="t.name"
        @click="handleSelectTicker(t)"
        :class="{'border-4': selectTicker === t}"
  ...
  methods: {
    add() {
      ...
      setInterval(async () => {
        ...
        // this.graph.push(this.selectTicker?.find(ticker => ticker.name === currentTicker.name).price);
    ...
    normilizeGraph() {
      ...
      // if( minValue === maxValue && this.graph.length) return 50;
